...
private:
    ...
    //Declare as unique pointer, this allows for exclusive ownership as task 1 requires
...
public:
    ...
    // getter / setter
    // *GetChatLogicHandle() { return _chatLogic; } //Change return type and use move semantics not copy constructor
